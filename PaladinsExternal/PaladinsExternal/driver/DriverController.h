...
{
public:
	DriverController(const char* TargetProcessName);
	...
	bool ResetProcessId(const char* TargetProcessName);
...
private:
	...
	HANDLE DriverHandle;
	unsigned __int32 GetProcessPidByName(const char* ProcessName);
};
